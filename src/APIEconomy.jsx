...
const APIEconomy = () => {
  ...
  <div className="services-link">
    ...
    <span>API Economy & Microservices</span>
    <span className="arrow">›</span>
  </div>
  ...
  <div className="ai-content">
    ...
    <h1>API Economy &<br></br> Microservices</h1>
   ...
   {/* ABOUT SERVICES SECTION */}
    <section className="about-services">
      ...
      <div className="about-left">
        <h2>About API Economy & Microservices</h2>
      </div>

      {/* RIGHT SIDE */}
      <div className="about-right">
        <p>
         The global economic landscape is changing due to the COVID-19 crisis. Businesses with multiple touchpoints have an immediate requirement for collaboration and connectivity between the applications, data, and processes. Infosys’ API Economy and Microservices, part of Infosys Cobalt, is focusing on business transformation through ecosystem connectivity, unlocking the value of data, and simplification and agility in digital initiatives during these times.
       </p>
      </div>
    </section>
  ...
  <h2 className="main-title">What's Happening</h2>
      ...
      <p className="sub-title">
       Highlights from API Economy: Connectivity, microservices and next-gen engineering
      </p>
  ...
  <div className="cards-container">
    ...
    <div className="news-card">
      ...
      <img
        src="https://www.infosys.com/content/dam/infosys-web/en/2025/thumbnails/ai-first-integration.jpg"
        alt="AI"
      />
    ...
    <div className="news-card">
      ...
      <img
        src="https://www.infosys.com/content/dam/infosys-web/en/2025/thumbnails/modernizing-integration.jpg"
        alt="Technology"
      />
      ...
      <div className="card-content">
        ...
        <h2>
         Modernizing Integration: A Strategic Approach
        </h2>
    ...
    <div className="offerings-wrapper">
     <section className="offerings-section">
      ...
      <div className="offerings-left">
        ...
        <h1>Our Offerings</h1>
        <p>Creating digital differentiation with a modernized core, hyper-connected ecosystems and extreme agility</p>
      ...
      <div className="offerings-right">
        ...
        <div className="links-section">
          ...
          <div className="links-column">
            <a href="/">01. API Speed Layer for agility in digital data, propositions and moments</a>
            <a href="/">02. Real time data insight, ingestion and intelligence acceleration</a>
    ...
    <section className="success-section">
      ...
      <div className="success-top">
        ...
        <div>
          ...
          <p>
           Execution speed and scale across digital transformation, modernization and building business ecosystems
          </p>
        </div>
      ...
      <div className="story-card">
        ...
        <div className="story-image">
          <img
            src="https://www.infosys.com/content/dam/infosys-web/en/2025/thumbnails/born-smart.jpg"
            alt="story"
          />
        </div>
        ...
        <div className="story-content">
          ...
          <h2>
           Birth of a Smart ID(ea)
          </h2>

          <p>
           How a ‘smart government’ transforms a cumbersome system for new parents, into a robust online solution.
          </p>
   ...
   <section className="insights-section">
      ...
      <div className="insights-container">
        ...
        <div className="insights-image">
          ...
          <img
            src="https://www.infosys.com/content/dam/infosys-web/en/2025/thumbnails/api-economy-insights.jpg"
            alt="Insights"
          />
        ...
        <div className="insights-right">
          ...
          <div className="insight-card">
            ...
            <h2>
             Embracing Microservices architecture in...
            </h2>
          ...
          <div className="insight-card">
            ...
            <h2>
            Micro UIs: Microservices Are Visual, Too
            </h2>
